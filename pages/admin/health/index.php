...
<?php if (empty($patients)): ?>
    ...
    <div class="bg-surface-container-low border border-outline-variant/30 rounded-[28px] sm:rounded-[32px] p-8 sm:p-12 text-center max-w-xl mx-auto">
...
<?php else: ?>
    ...
    <div id="healthContent" class="hidden">
        ...
        <div id="tab-bristol" class="tab-panel grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6">
            <form id="bristolForm" class="bg-surface-container-low border border-outline-variant/30 rounded-[24px] p-5 space-y-4 h-fit">
        ...
        <div id="tab-water" class="tab-panel grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6 hidden">
            <form id="waterForm" class="bg-surface-container-low border border-outline-variant/30 rounded-[24px] p-5 space-y-4 h-fit">
        ...
        <div id="tab-mood" class="tab-panel grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6 hidden">
            <form id="moodForm" class="bg-surface-container-low border border-outline-variant/30 rounded-[24px] p-5 space-y-4 h-fit">
        ...
        <div id="tab-medicine" class="tab-panel grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6 hidden">
            <form id="medicineForm" class="bg-surface-container-low border border-outline-variant/30 rounded-[24px] p-5 space-y-3 h-fit">
...
<style>
    .tab-btn { background-color: #eceef0; color: #424753; border-color: #c2c6d5; }
    .tab-btn.active { background-color: #0058bd; color: #ffffff; border-color: #0058bd; }
    .mood-btn.active { background-color: #0058bd; color: #ffffff; border-color: #0058bd; }
</style>
...
(function () {
    ...
    function renderBristol(logs) {
        ...
        list.innerHTML = logs.map(function (log) {
            return '<div class="bg-surface-container-low border border-outline-variant/30 rounded-2xl p-4">' +
    ...
    function renderWater(logs, totalToday) {
        ...
        if (!logs.length) { list.innerHTML = emptyState('No entries logged yet.'); return; }
        list.innerHTML = logs.map(function (log) {
            return '<div class="bg-surface-container-low border border-outline-variant/30 rounded-2xl p-4 flex justify-between items-center">' +
    ...
    function renderMedicines(medicines) {
        ...
        list.innerHTML = medicines.map(function (med) {
            ...
            return '<div class="bg-surface-container-low border border-outline-variant/30 rounded-2xl p-4" data-medicine-id="' + med.id + '">' +
