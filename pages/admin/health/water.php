...
<div class="flex h-screen overflow-hidden">
  ...
  <div class="flex-1 flex flex-col h-screen overflow-hidden">
    ...
    <main class="flex-1 overflow-y-auto p-6">
      <div class="mb-6"><h1 class="text-2xl font-bold">Water Intake Logs</h1></div><div class="bg-white p-6 rounded-2xl border shadow-sm">Table viewer.</div>
    </main>
  </div>
</div>
