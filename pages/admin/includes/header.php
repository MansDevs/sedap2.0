...
<head>
    ...
    <style>
        ...
        #adminSidebar.collapsed .sidebar-rail-badge,
        html.sidebar-collapsed #adminSidebar .sidebar-rail-badge {
        ...
        #adminSidebar.collapsed .sidebar-nav-item.active .sidebar-rail-badge,
        html.sidebar-collapsed #adminSidebar .sidebar-nav-item.active .sidebar-rail-badge {
        ...
        #adminSidebar.collapsed .sidebar-user > div:first-child,
        html.sidebar-collapsed #adminSidebar .sidebar-user > div:first-child {
            margin: 0 auto !important;
        }
    ...
    <aside id="adminSidebar" class="w-72 shrink-0 bg-surface-container-low border-r border-outline-variant/30 flex flex-col overflow-y-auto fixed inset-y-0 left-0 z-40 -translate-x-full transition-all duration-300 ease-in-out md:static md:translate-x-0 md:z-auto">
        ...
        <div class="p-3 border-t border-outline-variant/20 shrink-0">
            <div class="flex items-center gap-3 px-2 py-2 sidebar-user">
                ...
                <a href="<?php echo $adminBase; ?>../auth/logout.php" class="text-on-surface-variant hover:text-error p-1.5 rounded-full transition-colors shrink-0 sidebar-text" title="Log out">
