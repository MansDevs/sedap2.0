      ...
      <div class="settings-section">
          ...
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div>
                ...
                <div class="text-muted small"><?= __('settings_sound_desc', 'Mainkan nada amaran klinikal apabila mesej atau pesakit baharu tiba') ?></div>
              </div>
        ...
        <div class="card mb-4">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between">
              <span class="text-muted small">Peranan</span><span class="badge bg-primary"><?= ucfirst($_SESSION['user_role'] ?? 'Doctor') ?></span>
            </li>
