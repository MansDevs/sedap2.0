                ...
                <div class="divide-y divide-outline-variant/25">
                    ...
                    <div class="flex items-center justify-between py-3.5">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" id="doctorDarkModeToggle" class="sr-only peer" <?php echo !empty($currentUser['dark_mode']) ? 'checked' : ''; ?>>
...
<script>
    ...
    if (doctorDarkModeToggle) {
        doctorDarkModeToggle.addEventListener('change', async () => {
            const isDark = doctorDarkModeToggle.checked;
            ...
            try {
                const res = await fetch('<?php echo $doctorBase; ?>../shared/actions/set_dark_mode.php', {
                    method: 'POST',
