...
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['user_role'], ['volunteer', 'admin'])) {
  ...
  <div class="wrapper d-flex flex-column min-vh-100">
    ...
    <main class="container-fluid px-4 py-4">
      <div class="settings-section">
        <div class="mb-4">
          <h1 class="page-title"><span class="material-symbols-outlined" style="color:var(--cui-primary);">settings</span><?= __('settings_title', 'Tetapan Akaun') ?></h1>
          ...
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div>
                ...
                <div class="text-muted small"><?= __('settings_sound_desc', 'Mainkan nada amaran apabila mesej atau amaran lapangan baharu tiba') ?></div>
              </div>
        ...
        <div class="card mb-4">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between">
              <span class="text-muted small">Peranan</span><span class="badge bg-info text-dark">Sukarelawan</span>
            </li>
