...
<body class="bg-surface text-on-surface flex min-h-screen">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-primary/20 overflow-hidden p-6 text-center text-gray-500">
        Live Triage List - Ready to integrate with DB
    </div>
